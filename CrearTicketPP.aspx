            ...
            <div class="col">
                <form id="formulario_registro" class="form-check" runat="server">
                    <div>
                        ...
                        <div>
                            <asp:Button ID="BtnRegresar" Text="Regresar" Style="margin-right: 10px" CssClass="botones" runat="server" OnClick="BtnRegresar_Click" />
                            <asp:Button ID="BtnRegistrar" Text="Registrar" Style="margin-left: 1020px" CssClass="botones" runat="server" OnClick="BtnRegistrar_Click" />
                        </div>
                    </div>
                </form>
            </div>
