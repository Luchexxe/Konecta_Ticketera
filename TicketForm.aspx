<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="TicketForm.aspx.cs" Inherits="TicketForm.TicketForm" %>
...
<body class="bg-light bg-gradient">
    ...
    <form id="form1" runat="server">
            ...
            <div class="filtroAll">
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:DropDownList ID="DDProducto" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Style="width: 134px">
        ...
        <div style="overflow: scroll;">
            <asp:GridView ID="TicketResult" CssClass="table" OnRowDataBound="TicketResult_RowDataBound" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="TicketResult_SelectedIndexChanged">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
        ...
        <div class="modEstado">
            <table>
                ...
                <tr>
                    <td></td>
                    <td colspan="2">
                        <asp:Button ID="Button1" CssClass="botones" runat="server" Text="Grabar" OnClick="Button1_Click" />
        ...
        <div class="modEstado">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <asp:GridView ID="Observacion_ticket" CellPadding="-1" CellSpacing="-1" CssClass="GridView" GridLines="none" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="Observacion_ticket_SelectedIndexChanged">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
