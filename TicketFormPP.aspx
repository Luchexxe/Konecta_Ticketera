    ...
    <form id="form1" runat="server">
        <div>
            <div>
                ...
                <asp:Button ID="Button2" runat="server" Text="Registrar" Style="margin-left: 700px" CssClass="botones" OnClick="BtnRegistrar_Click" />
            ...
            <div class="PadreBotones">
                <div class="HijoBotones">
                    ...
                    <asp:Button ID="Limpiar" runat="server" Text="Limpiar" Style="margin-left: 50px" CssClass="botones" OnClick="Button3_Click" />
                    <asp:Button ID="Exportar" runat="server" Text="Exportar" Style="margin-left: 50px" CssClass="botones" OnClick="Button1_Click1" />
                </div>
            </div>
            <br />
        </div>
