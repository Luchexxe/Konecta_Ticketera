...
{
    public partial class TicketFormPP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["loggedUser"] != null  && Session["producto"].Equals("POWER_PAY") )
            {
                ...
                else if (Session["rol"].Equals("Supervisor"))
                {
                    string loggedUser = Session["loggedUser"].ToString();
                    lblBienvenida.Text = "Bienvenido/a " + loggedUser;
        ...
        protected void BtnCrearTicketEmail_Click(object sender, EventArgs e)
        {
            Session.Remove("Row");
           Response.Redirect("CrearTicketPP.aspx");
        }
        ...
        protected void BtnActualizarPW_Click(object sender, EventArgs e)
        {
            ...
            if (Session["rol"].Equals("Admin"))
            {
                Response.Redirect("ActualizarPassword_Super.aspx");
            }
            else
            {
        ...
        {
            string strFileName = "PP_Tickets_" + DateTime.Now.ToShortDateString() + ".xlsx";
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            if ((txtFecInicio.Text == "" && txtFecFin.Text == "") || (txtFecInicio.Text != "" && txtFecFin.Text != ""))
            {
                if (conn.State == System.Data.ConnectionState.Closed)
                    conn.Open();
                SqlDataAdapter sqlData = new SqlDataAdapter("GC_PP_TicketViewbyID", conn);
                sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;

                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Ticket", txtTicket.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Empresa", txtEmpresa.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Ruc", txtRUC.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_codAgente", txtcAgente.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_DNI", txtDNI.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Estado", DDEstado.SelectedItem.ToString());
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_fecInicio", txtFecInicio.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_fecFin", txtFecFin.Text);
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Medio", DDMedio.SelectedItem.ToString());
                sqlData.SelectCommand.Parameters.AddWithValue("@PP_Buzon", DDBuzon.SelectedItem.ToString());
                clear();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (conn.State == System.Data.ConnectionState.Closed)
                    conn.Open();
                SqlCommand sqlcmd = new SqlCommand("GC_PP_ActualizarTicket", conn);
                ...
                sqlcmd.Parameters.AddWithValue("@UsrTicket", Session["username"].ToString());
                ...
                SqlDataAdapter sqlData2 = new SqlDataAdapter("GC_PP_BitacoraTicket", conn);
        ...
        void FillGridView()
        {
            if (conn.State == System.Data.ConnectionState.Closed)
                conn.Open();
            SqlDataAdapter sqlData = new SqlDataAdapter("GC_PP_TicketView", conn);
            sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        protected void lnk_OnClick(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlData = new SqlDataAdapter("GC_PP_TicketViewbyID", conn);
            sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Ticket", ticketID);
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Empresa", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Ruc", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_codAgente","");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_DNI", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Estado", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_fecInicio", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_fecFin", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Medio", "");
            sqlData.SelectCommand.Parameters.AddWithValue("@PP_Buzon", "");
            DataTable dtbl = new DataTable();
            sqlData.Fill(dtbl);
            conn.Close();
        ...
        protected void ObsTicket_onClick(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Closed)
                conn.Open();
            SqlDataAdapter sqlData = new SqlDataAdapter("GC_PP_BitacoraTicketByID", conn);
            sqlData.SelectCommand.CommandType = CommandType.StoredProcedure;
