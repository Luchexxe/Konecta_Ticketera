...
namespace TicketForm
{
    ...
    {
        //SqlConnection conn = new SqlConnection(@"Data Source=10.37.16.12;initial catalog=BBVA_Konecta;user id=prueba;password=Aa123456.");
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionBBVA"].ConnectionString);
        // SqlConnection conn = new SqlConnection(@"Data Source=172.57.154.69;initial catalog=BBVA_G;user id=BBVA;password=XXII-33v463");
        ...
        public void GridviewToExcel()
        {
            ...
            {
                string ticket = row.Cells[1].Text;
                string codAgente = row.Cells[2].Text;
                string nomAgente = row.Cells[3].Text;
                string rucAgente = row.Cells[4].Text;
                string telAgente = row.Cells[5].Text;
                string direccion = row.Cells[6].Text;
                string producto = row.Cells[7].Text;
                string fecContacto = row.Cells[8].Text;
                string plazo = row.Cells[9].Text;
                string tTranscurrido= row.Cells[10].Text;
                string tFaltante= row.Cells[11].Text;
                string fecAtendido = row.Cells[12].Text;
                string estado = row.Cells[13].Text;
                string userAtencion = row.Cells[14].Text;
                string gesAtencion = row.Cells[15].Text;
                string Observacion = row.Cells[16].Text;
        ...
        protected void TicketResult_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void Observacion_ticket_SelectedIndexChanged(object sender, EventArgs e)
        {
           // Observacion_ticket.Rows[Observacion_ticket.SelectedIndex].BackColor = System.Drawing.Color.Azure;
        }
